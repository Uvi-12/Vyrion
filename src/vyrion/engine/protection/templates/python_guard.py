...
class GhostApprovalBlocked(Blocked):
    """Fail-closed error raised in-line when a guarded action is reached without a
    valid Seal. Subclasses Blocked so existing handlers still catch it."""
